...
function UpdateMineral() {
  ...
  const fetchData = async () => {
    const { data } = await axios.get(
      "http://127.0.0.1:8000/api/displayOne/" + checkValue
    );
    setId(data.id);
    setMineral(data);
  ...
  async function addUpdate() {
    ...
    let result = await fetch("http://127.0.0.1:8000/api/updateMineral", {
      method: "POST",
      body: formData,
    });
    ...
    <>
      ...
      <div className="col-sm-6 offset-sm-3 pdng-top mb">
        ...
        <input
          ...
          defaultValue={mineral.transparency}
        ></input>
        <br />
        <textarea
          type="text"
        ...
        <input
          ...
          defaultValue={mineral.image_path}
        ></input>
        <br />
        <img
        ...
        <br />
        <>
          <button className="btn btn-secondary" onClick={addUpdate}>
            Update Mineral
          </button>
          <br />
        </>
