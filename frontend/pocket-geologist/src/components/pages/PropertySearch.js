...
function PropertySearch() {
  ...
  const query = `http://127.0.0.1:8000/api/propertySearch?
    ...
    <>
      ...
      <div className="col-sm-6 offset-sm-3 pdng-top">
        ...
        <input
          ...
          placeholder="color (example:pink)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="facture (example:concoidal)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="habit (example:prismatic)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="hardness (example:7-8)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="luster (example:vitreous)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="optical properties (example:none)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="specific gravity (example:medium)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="streak (example:colorless)"
        ></input>
        <br />
        <input
          type="text"
          ...
          placeholder="transparency (example:translucent)"
        ></input>
        <br />
        <>
          <button className="btn btn-secondary" onClick={propertySearch}>
            Search
          </button>
          <br />
        </>
          ...
          <tbody>
            {data.data !== undefined ? (
              data.data.map((mineral) => (
                <tr>
                  <td className="hide">
                    <h4>{mineral.mineral}</h4>
                  </td>
                  <td className="hide">
                    <Link
                      className="group-hover"
                      to={"/displayGroup/?group=" + mineral.group}
                    >
                      {mineral.group}
                    </Link>
                  </td>
                  ...
                  <td>
                    <img
                      className="min-pic"
                      src={"http://127.0.0.1:8000/" + mineral.image_path}
                      alt="Mineral pic"
                    />
