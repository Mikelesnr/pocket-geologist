              ...
              {localStorage.getItem("user-info") ? (
                ...
                <div className="" style={{ backgroundColor: "transparent" }}>
                  <p className="col-md-6 col-sm-12 text-light offset-md-3">
                    Sign up for free and use our different search methods to
                    navigate our mineral database. It's so easy to use that you
                    can look for a mineral by simply typing its color in the
                    keyword search and comparing. For those with a bit more
                    knowledge, you can identify the mineral but doing tests and
                    entering the results in the property search.
                  </p>
                  <Link to="/login">
                    <button
              ...
              <div className="col-lg-6 col-md-12 mb">
                <div className="card bg-danger">
                  <div className="card-body">
                    ...
                    <Link to="/register">
                      <button className="btn btn-dark btn-home">Signup</button>
                    </Link>
                    <br />
                  </div>
                </div>
              ...
              <div className="col-lg-6 col-md-12 mb">
                <div className="card bg-danger">
                  <div className="card-body">
                    ...
                    >
                      Are you a Geology intern? Maybe you are a student, or
                      simply a mineral enthusiast. Join us and access our
                      extensive library of minerals. If we don't have it we will
                      add it soon.
                    </p>
                  </div>
                </div>
